<template>
  <div class="layout">
    <TopNav class="nav" :visibleAsideButton="true"></TopNav>
    <section class="content">
      <aside class="aside_menu" :class="{visible: asideVisible}">
        ...
        <ol>
          ...
          <li>
            <router-link to="/doc/blog">个人博客</router-link>
          </li>
          <li>
            <router-link to="/doc/moreProject">更多项目</router-link>
          </li>
          <li>
            <router-link to="/doc/thanks">致谢...</router-link>
          </li>
        </ol>
      </aside>
      <main>
